...
public class GameManagerScript : MonoBehaviour
{
    ...
    [SerializeField] private NodeScript _nodePrefab;
    ...
    private List<NodeScript> _nodes;
    private List<BlockScript> _blocks;
    ...
    {
        _round = 0;
        _nodes = new List<NodeScript>();
        _blocks = new List<BlockScript>();
    ...
    void SpawnBlock(NodeScript node, int value)
    {
    ...
    void MergeBlocks(BlockScript baseBlock, BlockScript mergingBlock)
    {
    ...
    void RemoveBlock(BlockScript block)
    {
        _blocks.Remove(block);
        Destroy(block.gameObject);
    }

    NodeScript GetNodeAtPosition(Vector2 pos)
    {
